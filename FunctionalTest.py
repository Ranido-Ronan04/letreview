...
class PageTest(unittest.TestCase):
	...
	def test_browser_test(self):
		...
		#self.assertIn('KPOP Group', self.browser.title)
			...
			self.assertIn('Students Profile', headerText)
			inputbox = self.browser.find_element_by_id('fname').send_keys("Ronan Kyle Ranido")
			self.assertEqual(inputbox.get_attribute('placeholder'),'Name of student.')
